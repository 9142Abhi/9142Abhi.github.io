          ...
          <div className="card project-card">
            <div className="box">
              ...
              <p className="techStack project-tech-stack">
                TechStack : JavaScrpit, HTML, CSS, React
              </p>
                ...
                <div className="repo-div">
                  <span>
                    ...
                    <a
                      ...
                      href="https://github.com/udaykashyap/makeshift-top-3565"
                      target="_blank"
                    >
                      {" "}
                      Git Repo{" "}
                ...
                <div className="demo-div">
                  <span>
                    ...
                    <a
                      ...
                      href="https://makeshift-top-3565.netlify.app/"
                      target="_blank"
                    >
                      Live{" "}
                    </a>
          ...
          <div className="card project-card">
            <div className="box">
              ...
              <p className="project-description">
                ...
                magazine published in India. It is owned by the Rajan Raheja
                Group.
              </p>
              <br />
              <p className="techStack project-tech-stack">
              ...
              <div className="repo-links">
                <div className="repo-div">
                  <span>
                    ...
                    <a
                      className="project-github-link"
                      href="https://github.com/9142Abhi/-knotty-sock-1389"
                      target="_blank"
                    >
                      {" "}
                      Git Repo{" "}
                ...
                <div className="demo-div">
                  <span>
                    ...
                    <a
                      className="project-deployed-link"
                      href="https://phenomenal-custard-74b904.netlify.app/"
                      target="_blank"
                    >
                      Live{" "}
                    </a>
          ...
          <div className="card project-card">
            <div className="box">
              ...
              <p className="project-description">
                ...
                the gap between students seeking internships and companies
                looking for interns.
              </p>
              <br />
              <p className="techStack project-tech-stack">
              ...
              <div className="repo-links">
                <div className="repo-div">
                  <span>
                    ...
                    <a
                      className="project-github-link"
                      href="https://github.com/saurav269/InternTheory-Website-Clone-"
                      target="_blank"
                    >
                      {" "}
                      Git Repo{" "}
                ...
                <div className="demo-div">
                  <span>
                    ...
                    <a
                      className="project-deployed-link"
                      href="https://sprightly-daifuku-a3b23a.netlify.app/"
                      target="_blank"
                    >
                      Live{" "}
                    </a>
